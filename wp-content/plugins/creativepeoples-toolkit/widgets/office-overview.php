		 				...
		 				<div class="office-overview-inner-content">
		 					<div class="section-title text-center">
		 						<div class="office-pay-btn">
		 							<a href="<?php echo $play_btn_link['url'] ?>" class="pop-up"><i class="fa fa-play"></i></a>
		 						</div>
		         				<h3 class="mb-25"><?php echo $section_big_title; ?></h3>
		         				<h1 class="mb-70"><?php echo $section_small_title; ?></h1>
		         			</div>
